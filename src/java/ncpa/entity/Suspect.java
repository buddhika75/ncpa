...
public class Suspect implements Serializable {
    ...
    public Suspect getCreater() {
        return creater;
    }

    public void setCreater(Suspect creater) {
    ...
    public Suspect getRetirer() {
        return retirer;
    }

    public void setRetirer(Suspect retirer) {
    ...
    public Suspect getActivator() {
        return activator;
    }

    public void setActivator(Suspect activator) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof Suspect)) {
            return false;
        }
        Suspect other = (Suspect) object;
