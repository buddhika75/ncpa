...
public class Victim implements Serializable {
    ...
    public Victim getCreater() {
        return creater;
    }

    public void setCreater(Victim creater) {
    ...
    public Victim getRetirer() {
        return retirer;
    }

    public void setRetirer(Victim retirer) {
    ...
    public Victim getActivator() {
        return activator;
    }

    public void setActivator(Victim activator) {
